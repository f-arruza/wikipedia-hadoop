...
import uniandes.reuters.mapreduce.NewsTitleCMapper;


public class NewsTitleWCounter {
	...
	public static void ejecutarJob(String entrada, String salida) throws IOException,ClassNotFoundException, InterruptedException
	{
		...
		wcJob.setJarByClass(NewsTitleWCounter.class);
		//////////////////////
		//Mapper
		//////////////////////
		
		wcJob.setMapperClass(NewsTitleCMapper.class);
